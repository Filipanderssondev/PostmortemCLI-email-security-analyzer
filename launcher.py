        ...
        try:
            ...
            if ext == '.msg':
                try:
                    ...
                    # Not a real OLE2 .msg (often an .eml with a .msg extension).
                    # Fall back to reading the file as raw RFC 822 bytes.
                    print(f'[*] {os.path.basename(filepath)} is not OLE2 — '
                          f'reading as raw email ({conv_err})')
                    raw = None
            if raw is None:
